...
class _ShoppingState extends State<Shopping> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
                ...
                return Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: TextButton(
                          onPressed: () {
                           addTask(controller.text, checkBoxValue,Boxes.getShoppingTasks());
                         controller.clear();
                          },
                          child: Container(
      ...
      appBar: AppBarWidget().AppBarForScreens("Shopping ToDo List"),
      body: ValueListenableBuilder<Box<Tasks>>(
        valueListenable: Boxes.getShoppingTasks().listenable(),
        builder: (context, box, widget) {
          ...
          List<int> taskKeys = box.keys.toList().cast();
            ...
            //ntBoxInstance.deleteFromDisk();
         // upDateTheNumberOfTasks(box.keys.length);
