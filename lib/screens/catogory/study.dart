...
class _StudyState extends State<Study> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
                ...
                return Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: TextButton(
                          onPressed: () {
                         addTask(controller.text, checkBoxValue,Boxes.getStudyTasks());
                         controller.clear();
      ...
      appBar: AppBarWidget().AppBarForScreens("Study ToDo List"),
      body: ValueListenableBuilder<Box<Tasks>>(
        valueListenable: Boxes.getStudyTasks().listenable(),
